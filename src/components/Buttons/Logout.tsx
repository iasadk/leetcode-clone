...
function Logout({}: Props) {
  ...
  return (
    <button onClick={handleLogout} className="cursor-pointer group relative">
      ...
      <div className="absolute top-[2.4rem] left-2/4 -translate-x-2/4  mx-auto bg-dark-layer-1 text-brand-orange p-2 rounded shadow-lg z-40 group-hover:scale-100 scale-0 transition-all duration-300 ease-in-out">
